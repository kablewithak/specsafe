...
second fresh held-out final-evaluation family:

```text
CSV5-210..CSV5-218
9 held-out position-spread case pairs
18 held-out source assets
36 held-out observations
3 cases per workload
```

Together, the authored held-out fixture boundary is now `CSV5-201..CSV5-218`: 18 case pairs,
36 source assets, and 72 observations. Final assets live exclusively under `final_evaluation/`.
...
final_evaluation/inputs/cases/CSV5-201.json .. CSV5-218.json
final_evaluation/expected_outcomes/cases/CSV5-201.json .. CSV5-218.json
```
...
- `CSV5-219..CSV5-236` remain unauthored final reservations.
